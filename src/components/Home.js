...
class Home extends React.Component {
  ...
  searchBook = (event) => {
    ...
    this.bookService.searchBooks(this.state.searchedBooks.owner_city, this.state.searchedBooks.title)
      .then((result) => result)
      .then((searched) => this.setState({ books: searched }))
  ...
  addToMyWishes = (book) => {
    ...
    this.bookService.addWish(book, userID, userName)
              ...
              <div class="card-body">
                <div class="card-text text-right">
                  {this.props.isLogged.username
                    ...
                    ? <Link class="button-noBack" data-toggle="tooltip" data-placement="top" data-html="true" title="Add to my wish list"
                      onClick={() => this.addToMyWishes(book)}>
                      <div class="heart"></div>
                    </Link>
                ...
                <div class="card-footer">
                  <small>
                    <Link class="nav-item nav-link" to={`/publicProfile/${book.owner._id}`}>User: {book.owner.username}</Link>
